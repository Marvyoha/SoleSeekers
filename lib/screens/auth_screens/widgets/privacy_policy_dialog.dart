  ...
  return showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          title: Text("SoleSeekers Privacy Policy"),
...
While using our App, we may ask you to provide us with certain personally identifiable information that can be used to contact or identify you. Personally identifiable information may include, but is not limited to your name, email address, postal address, phone number ("Personal Information").
...
If you have any questions about this Privacy Policy, please contact us at privacy@soleseekers.com''',
